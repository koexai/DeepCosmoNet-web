...
The DEMNUni simulations provide gravitational potential snapshots. Download pre-computed snapshots from the official DEMNUni data release.
...
This code is released under the MIT License. See for details. The DEMNUni simulation data may have separate usage agreements—check with the collaboration.
